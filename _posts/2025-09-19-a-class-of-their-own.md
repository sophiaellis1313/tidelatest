---
layout: blog
permalink: /articles/A-class-of-their-own
title: A class of their own
type: sailing
byline: 'WORDS: Samuel Jefferson '
issue_no: number 14
featured_image:
  image: /uploads/pink-gin-verde-yachtshot-h117-min.jpg
  position: img-center
video: false
video_path:
short-description: >-
  All based in Palma, Mallorca; all-in for the Superyacht Cup Palma. Find out
  how the four Baltic 68’s Café Racers performed together – against each other.
categories:
images:
...
The ‘Café Racer’ is a class that has slowly been gaining momentum since the launch of hull number one, *Pink Gin Verde*, in 2021. The concept for the yacht was for it to be an uncomplicated supersized luxury daysailer that could be either cruised or raced. For the uninitiated, the term ‘café racer’ refers to a genre of slick, stripped-down motorbike that rockers used back in the 60s to roar along the country roads outside London, stopping off at cafés and bars on the way. In sailing terms, it has generally come to signify a fast, stylish daysailer. But Baltic Yachts took up this concept and placed it on a much bigger canvas.

The results have been compelling. There is now a fleet of four Baltic 68’s: *Pink Gin Verde*, *Ganesha*, *Open Season* and *Scorpione Hormar*, the latest addition. All of these boats share Palma, Mallorca as a home base. The upshot of this has been that you suddenly have a class of well-matched sister ships all set to do battle on the racecourse. All four owners have profited from the boats locking horns in the Superyacht Cup Palma in late June: their presence and their healthy rivalry brought fresh energy and an exciting sub plot too.

“All these regattas in the Mediterranean are the perfect playground for this class,” explains Xim Benjumeda, Skipper of *Pink Gin Verde*: “Flat water and mid-range winds, 14-18kts are the perfect conditions for these boats to unleash their inner stallion; in those conditions you can fully power them and go at their maximum performance.”
...
Few know that better than Loic Fabre, Skipper of *Open Season*. “It’s a really fun and versatile boat,” he says. “In cruising mode, it’s moored up outside the owner’s villa and is ideal for a day sail – very simple. Prior to this, the owner had a 100-footer so the switch down to this smaller boat has made things really easy. Last year they did 23kn at les voiles de St Tropez, so that gives you some idea of its potential.”

Baltic designed the boat on an ‘unplug and play’ principle: the result is that it can easily be switched from cruising to race mode. “To switch the boat to race mode, you have to change the rig set up and also fully empty it,” Fabre explains. “The beauty of it is that the interior and cockpit is removable. It’s like Lego: you remove everything and voilà, you have a boat that’s ready to race.”
...
How seriously are these clashes taken? “Look, the owners of these boats are winners,” Loic Fabre explains. “It’s a serious race: our bosses are proper sailors, they enjoyed success on their previous boats so they take it very seriously.” His view is corroborated by Xim Benjumeda. “Competition is always fierce: all teams train hard and are full of excellent sailors, and everybody wants to win. Victory is a very sweet taste.” Let the battle commence.